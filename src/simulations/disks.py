...
class mass_loading:
	...
	r"""
	Mass-loading factor :math:`\eta \equiv \dot{M}_\star / \dot{M}_\text{out}`
	at fixed Galactocentric radius.
	"""
	...
	def radius(self, value):
		if isinstance(value, numbers.Number):
			...
			raise TypeError("Radius must be a numerical value. Got: %s" % (
				type(value)))
